...
@onready var mouseforceslider = $mouseforceslider
...
func _process(delta):
	...
	mouseforceslider.get_node("Label").text = "mouse force: " + str(mouseforceslider.value)
	...
	if (Input.is_action_pressed("rightclick")):
		FluidSimulation.InteractionForceCircle(get_global_mouse_position(), 100, mouseforceslider.value)
