...
;
    ...
    private void ApplyBoundaryConditions2()

    {
...

        {
            ...
            if (particle.pos.X < BoundaryMin.X){
                ...
                particle.pos.X = BoundaryMin.X;          // This makes the boundary sticky. Let's mke it reflective

                particle.pos.X = BoundaryMin.X + (BoundaryMin.X - particle.pos.X);
            ...
            if (particle.pos.X > BoundaryMax.X){
                ...
                particle.pos.X = BoundaryMax.X;          // This makes the boundary sticky. Let's mke it reflective

                particle.pos.X = BoundaryMax.X - (particle.pos.X - BoundaryMax.X);
            ...
            if (particle.pos.Y < BoundaryMin.Y){
                ...
                particle.pos.Y = BoundaryMin.Y;          // This makes the boundary sticky. Let's mke it reflective

                particle.pos.Y = BoundaryMin.Y + (BoundaryMin.Y - particle.pos.Y);
            ...
            if (particle.pos.Y > BoundaryMax.Y){
                ...
                particle.pos.Y = BoundaryMax.Y;          // This makes the boundary sticky. Let's mke it reflective

                particle.pos.Y = BoundaryMax.Y - (particle.pos.Y - BoundaryMax.Y);
